...
type Play struct {
	...
	Hosts          deploy.TargetSelector `yaml:"hosts" json:"hosts"`
...
type Task struct {
	...
	FailedWhen   *deploy.Condition `yaml:"failed_when,omitempty" json:"failed_when,omitempty"`
	ChangedWhen  *deploy.Condition `yaml:"changed_when,omitempty" json:"changed_when,omitempty"`
