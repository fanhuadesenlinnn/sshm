...
var commandCatalog = []commandCatalogEntry{
	...
	{Name: "passwd", Group: commandGroupSecrets, Short: "设置 SSH 密码", HelpUsage: "passwd <别名|ID>", HelpSummary: "设置 SSH 密码", LegacyOptions: []string{"--passwd"}},
	{Name: "forget-pass", Group: commandGroupSecrets, Short: "删除 SSH 密码", HelpUsage: "forget-pass <别名|ID>", HelpSummary: "删除 SSH 密码", LegacyOptions: []string{"--forget-pass"}},
	...
	{Name: "logs", Group: commandGroupConfig, Short: "查看或清理操作日志", HelpUsage: "logs [clean]", HelpSummary: "查看或清理操作日志"},
