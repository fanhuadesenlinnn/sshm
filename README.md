...
> 版本说明：产品发布版本是 `v6.0.0`，Go module 是 `github.com/fanhuadesenlinnn/sshm/v6`，主配置与 Deploy 配置的 schema 都是 `version: 2`。
...
```bash
go install github.com/fanhuadesenlinnn/sshm/v6@v6.0.0
```
